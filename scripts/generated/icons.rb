    ...
    iss.subspec "ic_check" do |ss|
      ...
      ss.resource_bundles = {
        "MaterialIcons_ic_check" => [
          ...
          "components/private/Icons/icons/ic_check/src/MaterialIcons_ic_check.bundle/*.xcassets"
        ]
      }
      ss.dependency "#{Pathname.new(ss.name).dirname}/Base"
    end
    ...
    iss.subspec "ic_check_circle" do |ss|
      ...
      ss.resource_bundles = {
        "MaterialIcons_ic_check_circle" => [
          ...
          "components/private/Icons/icons/ic_check_circle/src/MaterialIcons_ic_check_circle.bundle/*.xcassets"
        ]
      }
      ss.dependency "#{Pathname.new(ss.name).dirname}/Base"
    end
    ...
    iss.subspec "ic_chevron_right" do |ss|
      ...
      ss.resource_bundles = {
        "MaterialIcons_ic_chevron_right" => [
          ...
          "components/private/Icons/icons/ic_chevron_right/src/MaterialIcons_ic_chevron_right.bundle/*.xcassets"
        ]
      }
      ss.dependency "#{Pathname.new(ss.name).dirname}/Base"
    end
    ...
    iss.subspec "ic_info" do |ss|
      ...
      ss.resource_bundles = {
        "MaterialIcons_ic_info" => [
          ...
          "components/private/Icons/icons/ic_info/src/MaterialIcons_ic_info.bundle/*.xcassets"
        ]
      }
      ss.dependency "#{Pathname.new(ss.name).dirname}/Base"
    end
    ...
    iss.subspec "ic_radio_button_unchecked" do |ss|
      ...
      ss.resource_bundles = {
        "MaterialIcons_ic_radio_button_unchecked" => [
          ...
          "components/private/Icons/icons/ic_radio_button_unchecked/src/MaterialIcons_ic_radio_button_unchecked.bundle/*.xcassets"
        ]
      }
      ss.dependency "#{Pathname.new(ss.name).dirname}/Base"
    end
    ...
    iss.subspec "ic_reorder" do |ss|
      ...
      ss.resource_bundles = {
        "MaterialIcons_ic_reorder" => [
          ...
          "components/private/Icons/icons/ic_reorder/src/MaterialIcons_ic_reorder.bundle/*.xcassets"
        ]
      }
      ss.dependency "#{Pathname.new(ss.name).dirname}/Base"
    end
