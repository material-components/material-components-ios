...
- (void)viewDidLoad {
  ...
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, kPestoDetailViewControllerAnimationDuration * NSEC_PER_SEC), dispatch_get_main_queue(), ^{
...
- (void)tapDetected {
  [_animationView startAnimatingWithCompletion:^{
    ...
    UIImage *spriteImage = [UIImage imageNamed:_showMenuIcon ? kPestoDetailViewControllerMenuBack : kPestoDetailViewControllerBackMenu];
    _animationView.spriteSheetImage = spriteImage;
