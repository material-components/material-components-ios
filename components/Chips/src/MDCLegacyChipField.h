...
// TODO(cl/315839473): Delete MDCLegacyChipField.h after migrating.
...
extern const CGFloat MDCLegacyChipFieldDefaultMinTextFieldWidth;

/** The default content edge insets for the MDCChipField. */
extern const UIEdgeInsets MDCLegacyChipFieldDefaultContentEdgeInsets;

@protocol MDCLegacyChipFieldDelegate;

/** Defines when text field input is changed into a chip. */
typedef NS_OPTIONS(NSUInteger, MDCLegacyChipFieldDelimiter) {
  MDCLegacyChipFieldDelimiterNone = 0,
  MDCLegacyChipFieldDelimiterReturn = 1 << 0,
  MDCLegacyChipFieldDelimiterSpace = 1 << 1,
  MDCLegacyChipFieldDelimiterDidEndEditing = 1 << 2,
  MDCLegacyChipFieldDelimiterDefault = (MDCLegacyChipFieldDelimiterReturn |
                                        MDCLegacyChipFieldDelimiterDidEndEditing),
  MDCLegacyChipFieldDelimiterAll = 0xFFFFFFFF
};

/**
 This class is a legacy fork of MDCChipField. It is temporary, and will be deleted after each
 client has been individually migrated.
 */
@interface MDCLegacyChipField : UIView
 ...
 */
@property(nonatomic, assign) MDCLegacyChipFieldDelimiter delimiter;
 ...
 */
@property(nonatomic, nullable, weak) id<MDCLegacyChipFieldDelegate> delegate;
