...
+ (MDCPalette *)redPalette {
  ...
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFFEBEE),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xFF8A80),
...
+ (MDCPalette *)pinkPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFCE4EC),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xFF80AB),
...
+ (MDCPalette *)purplePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xF3E5F5),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xEA80FC),
...
+ (MDCPalette *)deepPurplePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xEDE7F6),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xB388FF),
...
+ (MDCPalette *)indigoPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xE8EAF6),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0x8C9EFF),
...
+ (MDCPalette *)bluePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xE3F2FD),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0x82B1FF),
...
+ (MDCPalette *)lightBluePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xE1F5FE),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0x80D8FF),
...
+ (MDCPalette *)cyanPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xE0F7FA),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0x84FFFF),
...
+ (MDCPalette *)tealPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xE0F2F1),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xA7FFEB),
...
+ (MDCPalette *)greenPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xE8F5E9),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xB9F6CA),
...
+ (MDCPalette *)lightGreenPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xF1F8E9),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xCCFF90),
...
+ (MDCPalette *)limePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xF9FBE7),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xF4FF81),
...
+ (MDCPalette *)yellowPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFFFDE7),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xFFFF8D),
...
+ (MDCPalette *)amberPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFFF8E1),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xFFE57F),
...
+ (MDCPalette *)orangePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFFF3E0),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xFFD180),
...
+ (MDCPalette *)deepOrangePalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFBE9E7),
                                  ...
                                  accents:@{MDCPaletteAccent100Name : ColorFromRGB(0xFF9E80),
...
+ (MDCPalette *)brownPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xEFEBE9),
...
+ (MDCPalette *)greyPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xFAFAFA),
...
+ (MDCPalette *)blueGreyPalette {
  ...
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    palette = [[self alloc] initWithTints:@{ MDCPaletteTint50Name : ColorFromRGB(0xECEFF1),
