...
/*
 ...
 If set to YES, the text fonts and buttons font will be based on the scalable fonts set on this banner.

 Default value is NO.
 */
@property(nonatomic, readwrite, setter=mdc_setAdjustsFontForContentSizeCategory:, assign) BOOL mdc_adjustsFontForContentSizeCategory;
