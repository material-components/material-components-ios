...
#import "ManualLayoutListCellExample.h"
#import "CollectionViewListCell.h"
#import "ManualLayoutListItemCell.h"


static NSString *const kManualLayoutListItemCellReuseIdentifier = @"kManualLayoutListItemCellReuseIdentifier";

static const CGFloat kSmallestCellHeight = 40.f;
static const CGFloat kSmallArbitraryCellWidth = 200.f;

@interface ManualLayoutListCellExample ()

@end

@implementation ManualLayoutListCellExample
...
#endif
  // Register cell class.
  [self.collectionView registerClass:[ManualLayoutListItemCell class]
          forCellWithReuseIdentifier:kManualLayoutListItemCellReuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
  ...
  ManualLayoutListItemCell *cell =
  [collectionView dequeueReusableCellWithReuseIdentifier:kManualLayoutListItemCellReuseIdentifier
...
+ (NSArray *)catalogBreadcrumbs {
  return @[ @"Lists", @"Manual Layout Based List" ];
}
...
+ (NSString *)catalogDescription {
  return @"Manual Layout Based List";
}
