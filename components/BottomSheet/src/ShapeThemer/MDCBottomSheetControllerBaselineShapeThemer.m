...
@implementation MDCBottomSheetControllerBaselineShapeThemer

+ (void)applyShapeBaselineToBottomSheetController:
    (MDCBottomSheetController *)bottomSheetController {
  ...
  [rectangleShapePreferred setCorners:cornerTreatment];
