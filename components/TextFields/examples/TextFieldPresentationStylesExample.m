...
- (void)setupImages {
  self.leadingImage = [UIImage imageNamed:@"ic_search" inBundle:[NSBundle bundleForClass:[TextFieldPresentationStylesExample class]] compatibleWithTraitCollection:nil];
  self.trailingImage = [UIImage imageNamed:@"ic_done" inBundle:[NSBundle bundleForClass:[TextFieldPresentationStylesExample class]] compatibleWithTraitCollection:nil];
}
...
- (void)setupTextFields {
  ...
  textFieldDefaultCharMax.leadingView = [[UIImageView alloc] initWithImage:self.leadingImage];
  textFieldDefaultCharMax.leadingViewMode = UITextFieldViewModeAlways;
  textFieldDefaultCharMax.trailingView = [[UIImageView alloc] initWithImage:self.trailingImage];
  textFieldDefaultCharMax.trailingViewMode = UITextFieldViewModeAlways;
