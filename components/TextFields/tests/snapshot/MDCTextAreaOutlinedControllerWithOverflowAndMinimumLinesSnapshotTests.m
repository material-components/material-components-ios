...
@interface MDCTextAreaOutlinedControllerWithOverflowAndMinimumLinesSnapshotTests
    : MDCAbstractTextFieldSnapshotTests
@end

@implementation MDCTextAreaOutlinedControllerWithOverflowAndMinimumLinesSnapshotTests
