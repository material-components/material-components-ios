...
@interface MDCTextAreaOutlinedControllerWithOverflowAndMinimumLinesArabicSnapshotTests
    : MDCAbstractTextFieldSnapshotTests
@end

@implementation MDCTextAreaOutlinedControllerWithOverflowAndMinimumLinesArabicSnapshotTests
