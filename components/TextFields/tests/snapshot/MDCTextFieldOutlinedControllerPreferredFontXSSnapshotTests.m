...
@interface MDCTextFieldOutlinedControllerPreferredFontXSSnapshotTestsFake : SnapshotFakeMDCTextField
@property(nonatomic, strong) UITraitCollection *traitCollectionOverride;
@end

@implementation MDCTextFieldOutlinedControllerPreferredFontXSSnapshotTestsFake
...
@interface MDCTextFieldOutlinedControllerPreferredFontXSSnapshotTests
    : MDCAbstractTextFieldSnapshotTests <MDCTextFieldSnapshotTestCaseHooking>

@end

@implementation MDCTextFieldOutlinedControllerPreferredFontXSSnapshotTests
