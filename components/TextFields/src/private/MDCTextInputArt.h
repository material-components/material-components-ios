...
static inline UIBezierPath *MDCPathForClearButtonImageFrame(CGRect frame) {
  ...
  [ic_clear_path moveToPoint:CGPointMake(CGRectGetMinX(innerBounds) +
                                             0.50000f * innerBounds.size.width,
  ...
  [ic_clear_path
      addCurveToPoint:CGPointMake(
        ...
        controlPoint1:CGPointMake(
                          CGRectGetMinX(innerBounds) + 0.77600f * innerBounds.size.width,
                          CGRectGetMinY(innerBounds) + 0 * innerBounds.size.height)
  ...
  [ic_clear_path
      addCurveToPoint:CGPointMake(
                          CGRectGetMinX(innerBounds) + 0.50000f * innerBounds.size.width,
  ...
  [ic_clear_path
      addCurveToPoint:CGPointMake(
                          ...
                          CGRectGetMinY(innerBounds) + 0.50000f * innerBounds.size.height)
        controlPoint1:CGPointMake(
                          CGRectGetMinX(innerBounds) + 0.22400f * innerBounds.size.width,
                          CGRectGetMinY(innerBounds) + 1 * innerBounds.size.height)
        controlPoint2:CGPointMake(
                          CGRectGetMinX(innerBounds) + 0 * innerBounds.size.width,
                          CGRectGetMinY(innerBounds) + 0.77600f * innerBounds.size.height)];
  ...
  [ic_clear_path
      moveToPoint:CGPointMake(
                      CGRectGetMinX(innerBounds) + 0.73417f * innerBounds.size.width,
                      CGRectGetMinY(innerBounds) + 0.31467f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.68700f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.26750f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.50083f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.45367f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.31467f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.26750f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.26750f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.31467f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.45367f * innerBounds.size.width,
  ...
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.54800f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.50083f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.73417f * innerBounds.size.width,
...
static inline UIBezierPath *MDCPathForClearButtonLegacyImageFrame(CGRect frame) {
  ...
  [ic_clear_path moveToPoint:CGPointMake(CGRectGetMinX(innerBounds) + 1 * innerBounds.size.width,
                                         CGRectGetMinY(innerBounds) +
                                             0.10107f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.89893f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0 * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.50000f * innerBounds.size.width,
  ...
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.10107f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0 * innerBounds.size.height)];
  ...
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.39893f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.50000f * innerBounds.size.height)];
  [ic_clear_path addLineToPoint:CGPointMake(CGRectGetMinX(innerBounds) + 0 * innerBounds.size.width,
                                            CGRectGetMinY(innerBounds) +
                                                0.89893f * innerBounds.size.height)];
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.10107f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 1 * innerBounds.size.height)];
  ...
  [ic_clear_path
      addLineToPoint:CGPointMake(
                         CGRectGetMinX(innerBounds) + 0.60107f * innerBounds.size.width,
                         CGRectGetMinY(innerBounds) + 0.50000f * innerBounds.size.height)];
  [ic_clear_path addLineToPoint:CGPointMake(CGRectGetMinX(innerBounds) + 1 * innerBounds.size.width,
                                            CGRectGetMinY(innerBounds) +
                                                0.10107f * innerBounds.size.height)];
