...
+ (NSArray<UIColor *> *)defaultColors {
  ...
  dispatch_once(&onceToken, ^{
    ...
    defaultColors = @[
      [primaryColor colorWithAlphaComponent:0.95f], [primaryColor colorWithAlphaComponent:0.90f],
      [primaryColor colorWithAlphaComponent:0.85f], [primaryColor colorWithAlphaComponent:0.80f],
