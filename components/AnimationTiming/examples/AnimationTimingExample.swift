...
//  Test
//
//  Created by Cody Weaver on 8/23/17.
...
struct k {
>>>>>>> 15b64e46b5687bb9ee09dde4355bc250b7078c99
...
<<<<<<< HEAD
   let overflowView: UIView = UIView()
...
=======
   override func viewDidAppear(_ animated: Bool) {
      super.viewDidAppear(animated)
      let timeInterval: TimeInterval = 2 * (k.AnimationTime.interval + k.AnimationTime.delay)
      var _: Timer = Timer.scheduledTimer(timeInterval: timeInterval, target: self, selector: #selector(self.playAnimations), userInfo: nil, repeats: true)
>>>>>>> 15b64e46b5687bb9ee09dde4355bc250b7078c99
   }
...
=======
      let materialEaseInOut: CAMediaTimingFunction = CAMediaTimingFunction.mdc_function(withType: .easeInOut)
      applyAnimation(toView: materialEaseInOutView, withTimingFunction: materialEaseInOut)
      
      let materialEaseOut: CAMediaTimingFunction = CAMediaTimingFunction.mdc_function(withType: .easeOut)
      applyAnimation(toView: materialEaseOutView, withTimingFunction: materialEaseOut)
      
      let materialEaseIn: CAMediaTimingFunction = CAMediaTimingFunction.mdc_function(withType: .easeIn)
      applyAnimation(toView: materialEaseInView, withTimingFunction: materialEaseIn)
>>>>>>> 15b64e46b5687bb9ee09dde4355bc250b7078c99
   }
...
<<<<<<< HEAD
      UIView.mdc_animate(with: timingFunction, duration: Constants.AnimationTime.interval, delay: Constants.AnimationTime.delay, options: [], animations: {
         ...
         UIView.mdc_animate(with: timingFunction, duration: Constants.AnimationTime.interval, delay: Constants.AnimationTime.delay, options: [], animations: {
=======
      UIView.mdc_animate(with: timingFunction, duration: k.AnimationTime.interval, delay: k.AnimationTime.delay, options: [], animations: {
         view.transform = transform
      }, completion: { Bool in
         UIView.mdc_animate(with: timingFunction, duration: k.AnimationTime.interval, delay: k.AnimationTime.delay, options: [], animations: {
>>>>>>> 15b64e46b5687bb9ee09dde4355bc250b7078c99
...
=======
      linearLabel.frame = CGRect(x: k.Sizes.leftGutter, y: k.Sizes.topMargin, width: linearLabel.frame.size.width, height: linearLabel.frame.size.height)
      scrollView.addSubview(linearLabel)
      
      let linearViewFrame: CGRect = CGRect(x: k.Sizes.leftGutter, y: k.Sizes.leftGutter + k.Sizes.topMargin, width: k.Sizes.circleSize.width, height: k.Sizes.circleSize.height)
      linearView.frame = linearViewFrame
      linearView.backgroundColor = defaultColors[0]
      linearView.layer.cornerRadius = k.Sizes.circleSize.width / 2.0
      scrollView.addSubview(linearView)
      
      let materialEaseInOutLabel: UILabel = curveLabel("MDCAnimationTimingFunctionEaseInOut")
      materialEaseInOutLabel.frame = CGRect(x: k.Sizes.leftGutter, y: lineSpace, width: materialEaseInOutLabel.frame.size.width, height: materialEaseInOutLabel.frame.size.height)
      scrollView.addSubview(materialEaseInOutLabel)
      
      let materialEaseInOutViewFrame: CGRect = CGRect(x: k.Sizes.leftGutter, y: lineSpace + k.Sizes.textOffset, width: k.Sizes.circleSize.width, height: k.Sizes.circleSize.height)
      materialEaseInOutView.frame = materialEaseInOutViewFrame
      materialEaseInOutView.backgroundColor = defaultColors[1]
      materialEaseInOutView.layer.cornerRadius = k.Sizes.circleSize.width / 2.0
      scrollView.addSubview(materialEaseInOutView)
      
      let materialEaseOutLabel: UILabel = curveLabel("MDCAnimationTimingFunctionEaseOut")
      materialEaseOutLabel.frame = CGRect(x: k.Sizes.leftGutter, y: lineSpace * 2.0, width: materialEaseOutLabel.frame.size.width, height: materialEaseOutLabel.frame.size.height)
      scrollView.addSubview(materialEaseOutLabel)
      
      let materialEaseOutViewFrame: CGRect = CGRect(x: k.Sizes.leftGutter, y: lineSpace * 2.0 + k.Sizes.textOffset, width: k.Sizes.circleSize.width, height: k.Sizes.circleSize.height)
      materialEaseOutView.frame = materialEaseOutViewFrame
      materialEaseOutView.backgroundColor = defaultColors[2]
      materialEaseOutView.layer.cornerRadius = k.Sizes.circleSize.width / 2.0
      scrollView.addSubview(materialEaseOutView)
      
      let materialEaseInLabel: UILabel = curveLabel("MDCAnimationTimingFunctionEaseIn")
      materialEaseInLabel.frame = CGRect(x: k.Sizes.leftGutter, y: lineSpace * 3.0, width: materialEaseInLabel.frame.size.width, height: materialEaseInLabel.frame.size.height)
      scrollView.addSubview(materialEaseInLabel)
      
      let materialEaseInViewFrame: CGRect = CGRect(x: k.Sizes.leftGutter, y: lineSpace * 3.0 + k.Sizes.textOffset, width: k.Sizes.circleSize.width, height: k.Sizes.circleSize.height)
      materialEaseInView.frame = materialEaseInViewFrame
      materialEaseInView.backgroundColor = defaultColors[3]
      materialEaseInView.layer.cornerRadius = k.Sizes.circleSize.width / 2.0
>>>>>>> 15b64e46b5687bb9ee09dde4355bc250b7078c99
