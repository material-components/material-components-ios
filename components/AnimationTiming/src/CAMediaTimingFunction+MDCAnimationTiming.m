...
+ (CAMediaTimingFunction *)mdc_functionWithType:(MDCAnimationTimingFunction)type {
  switch (type) {
    case MDCAnimationTimingFunctionStandard:
      return [[CAMediaTimingFunction alloc] initWithControlPoints:0.4f:0:0.2f:1];
    case MDCAnimationTimingFunctionDeceleration:
      return [[CAMediaTimingFunction alloc] initWithControlPoints:0:0:0.2f:1];
    case MDCAnimationTimingFunctionAcceleration:
      return [[CAMediaTimingFunction alloc] initWithControlPoints:0.4f:0:1:1];
    case MDCAnimationTimingFunctionSharp:
      return [[CAMediaTimingFunction alloc] initWithControlPoints:0.4f:0:0.6f:1];
  }
