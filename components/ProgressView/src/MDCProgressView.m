...
- (void)updateProgressView {
  ...
  CGFloat scale = self.window.screen ? self.window.screen.scale : 1;
  CGFloat width = self.progress * CGRectGetWidth(self.bounds);
  CGFloat progressWidth = MDCRound(width * scale) / scale;
