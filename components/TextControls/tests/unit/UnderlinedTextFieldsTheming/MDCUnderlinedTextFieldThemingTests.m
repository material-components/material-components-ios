...
@interface MDCUnderlinedTextFieldThemingTest : XCTestCase
@property(nonatomic, strong) MDCUnderlinedTextField *textField;
@property(nonatomic, strong) MDCSemanticColorScheme *colorScheme;
@property(nonatomic, strong) MDCTypographyScheme *typographyScheme;
@property(nonatomic, strong) MDCContainerScheme *containerScheme;
@end

@implementation MDCUnderlinedTextFieldThemingTest

- (void)setUp {
  [super setUp];

  self.textField = [[MDCUnderlinedTextField alloc] init];
  self.colorScheme =
