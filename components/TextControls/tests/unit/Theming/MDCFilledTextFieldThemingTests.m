...
//        self.containerScheme.colorScheme.primaryColor);
//    XCTAssertEqualObjects([self.bannerView.trailingButton
...
//
//  // Typography
//  XCTAssertEqualObjects(self.bannerView.textView.font,
//  self.containerScheme.typographyScheme.body2); for (NSUInteger state = 0; state <=
//  maximumStateValue; ++state) {
