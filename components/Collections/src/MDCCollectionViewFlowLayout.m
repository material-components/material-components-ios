...
- (void)storeSupplementaryViewsWithAttributes:(NSArray *)attributes {
...
- (void)addDecorationViewIfNecessary:(NSMutableArray *)attributes {
...
- (void)beginCellAppearanceAnimationIfNecessary:(NSMutableArray *)attributes {
