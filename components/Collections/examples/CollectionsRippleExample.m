...
#import "supplemental/CollectionsRippleExample.h"
#import "MaterialCollections.h"
#import "MaterialPalettes.h"

static NSString *const kReusableIdentifierItem = @"itemCellIdentifier";

@implementation CollectionsRippleExample {
  NSArray *_content;
}
...
- (void)viewDidLoad {
  ...
  // Populate content.
  _content = @[
    @"Default ripple color", @"Custom blue ripple color", @"Custom red ripple color",
    @"Ripple hidden on this cell"
  ];
...
+ (NSDictionary *)catalogMetadata {
  return @{
    @"breadcrumbs" : @[ @"Collections", @"Cell Ripple Example" ],
    @"primaryDemo" : @NO,
    @"presentable" : @NO,
  };
}
