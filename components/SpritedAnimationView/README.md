...
<!--{% else %}See <a href="https://github.com/material-components/material-components-ios/tree/develop/components/SpritedAnimationView">GitHub</a> for README documentation.{% endif %}-->
