...
- (instancetype)initWithLayer:(id)layer {
  if (self = [super initWithLayer:layer]) {
    if ([layer isKindOfClass:[MDCShapeLayer class]]) {
      MDCShapeLayer *shapedLayer = (MDCShapeLayer *)layer;

      self.shapeGenerator = [shapedLayer.shapeGenerator copyWithZone:nil];
    }
  }
  return self;
}
