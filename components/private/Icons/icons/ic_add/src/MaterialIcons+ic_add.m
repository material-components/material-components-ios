...
static NSString *const kBundleName = @"MaterialIcons_ic_add";
static NSString *const kIconName = @"ic_add";

// Export a nonsense symbol to suppress a libtool warning when this is linked alone in a static lib.
__attribute__((visibility("default")))
    char MDCIconsExportToSuppressLibToolWarning_ic_add = 0;

@implementation MDCIcons (ic_add)

+ (nonnull NSString *)pathFor_ic_add {
  return [self pathForIconName:kIconName withBundleName:kBundleName];
}

+ (nullable UIImage *)imageFor_ic_add {
