 ...
 */
- (void)addAction:(nonnull MDCActionEntry *)action;
 ...
 */
@property(nonatomic, nonnull, readonly) NSArray<MDCActionEntry *> *actions;
 ...
 */
typedef void (^MDCActionSheetHandler)(MDCActionEntry *_Nonnull action);

/**
 MDCAlertAction is passed to an MDCAlertController to add a button to the alert dialog.
 */
@interface MDCActionEntry : NSObject <NSCopying>
