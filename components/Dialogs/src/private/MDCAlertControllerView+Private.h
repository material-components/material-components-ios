...
/**
 ...
 edges (top, leading, trailing) and the title (bottom). Note that titleIconInsets.bottom overrides
 titleInsets.top.
...
/**
 The edge insets around the title against the dialog edges or its neighbor elements.
 If either the title icon or title icon view is present, then titleIconInsets.bottom overrides
...
/**
 ...
 Default value is 8.
 */
@property(nonatomic, assign) CGFloat actionsHorizontalInset;
...
/**
 ...
 Default value is 12.
 */
@property(nonatomic, assign) CGFloat actionsVerticalInset;
