...
@interface MDCActionEntry ()

@property(nonatomic, nullable, copy) MDCActionSheetHandler completionHandler;

@end

@implementation MDCActionEntry

+ (instancetype)actionWithTitle:(nonnull NSString *)title
                        handler:(void (^__nullable)(MDCActionEntry *action))handler {
  return [[MDCActionEntry alloc] initWithTitle:title handler:handler];
}
...
- (id)copyWithZone:(__unused NSZone *)zone {
  MDCActionEntry *action = [[self class] actionWithTitle:self.title handler:self.completionHandler];
...
@implementation MDCActionSheetController {
  ...
  NSMutableArray<MDCActionEntry *> *_actions;
...
+ (instancetype)alertControllerWithTitle:(nullable NSString *)alertTitle
                                 message:(nullable NSString *)message {
  MDCActionSheetController *alertController =
      [[MDCActionSheetController alloc] initWithTitle:alertTitle message:message];
...
- (NSArray<MDCActionEntry *> *)actions {
  return [_actions copy];
}

- (void)addAction:(MDCActionEntry *)action {
...
- (void)actionButtonPressed:(id)sender {
  ...
  MDCActionEntry *action = self.actions[actionIndex];
