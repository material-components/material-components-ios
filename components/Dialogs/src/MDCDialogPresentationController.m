...
// By default the shadow displayed under our presented view is generated by our tracking view, not
// the presented view.
// shadowHidden wraps the hidden property of our tracking view to avoid duplication.
- (void)setShadowHidden:(BOOL)shadowHidden {
  _trackingView.hidden = shadowHidden;
}

- (BOOL)isShadowHidden {
  return _trackingView.hidden;
}
