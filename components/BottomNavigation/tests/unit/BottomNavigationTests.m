...
- (void)testDefaultShadowColor {
  ...
  XCTAssertEqual(self.bottomNavBar.layer.shadowColor, UIColor.blackColor.CGColor, @"(%@) is not equal to (%@)", self.bottomNavBar.layer.shadowColor, UIColor.blackColor.CGColor);
}
...
- (void)testCustomShadowColor {
  ...
  XCTAssertEqual(self.bottomNavBar.layer.shadowColor, fakeColor.CGColor, @"(%@) is not equal to (%@)", self.bottomNavBar.layer.shadowColor, fakeColor.CGColor);
}
