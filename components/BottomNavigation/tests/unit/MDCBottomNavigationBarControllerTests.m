...
/**
 * A coder object used for testing state restoration of the bottom navigation controller. References
 * to encoded objects are stored in memory and retained by this object.
