...
- (void)testLargeContentImageWithTabBarLargeContentImage NS_AVAILABLE_IOS(13_0) {
  // Given.
  UIImage *image = [[UIImage alloc] init];
...
- (void)testLargeContentImageInsets NS_AVAILABLE_IOS(13_0) {
  // Given.
...
- (void)testLargeContentInsetUpdatedWhenTabBarPropertyUpdates NS_AVAILABLE_IOS(13_0) {
  ...
  // When.
  item.largeContentSizeImageInsets = insets;
  UIEdgeInsets largeContentInsets = self.bottomNavBar.itemViews.firstObject.largeContentImageInsets;
...
- (void)testLargeContentViewerInteractionWhenPointIsOutSideNavBarBounds NS_AVAILABLE_IOS(13_0) {
  ...
  id<UILargeContentViewerItem> largeContentItem =
      [self.bottomNavBar largeContentViewerInteraction:interaction itemAtPoint:pointOutsideNavBar];
  XCTAssertNil(largeContentItem);
}

/** Tests the last shown large item is reset after an interaction ends. */
- (void)testLargeContentViewerInteractionResetsAfterEnding NS_AVAILABLE_IOS(13_0) {
  // Given.
  UITabBarItem *item = [[UITabBarItem alloc] initWithTitle:@"Title1" image:nil tag:0];
  self.bottomNavBar.items = @[ item ];
  self.bottomNavBar.frame = CGRectMake(0, 0, 350, 125);
