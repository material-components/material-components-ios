...
class NavigationBarAccessibilityMutatorTestColorTest: XCTestCase {
  ...
  func testNoBackgroundColor() {
    ...
    let fontColorBefore = navBar.titleTextAttributes?[NSAttributedString.Key.foregroundColor] as? UIColor
    ...
    // Then
    let fontColorAfter = navBar.titleTextAttributes?[NSAttributedString.Key.foregroundColor] as? UIColor
