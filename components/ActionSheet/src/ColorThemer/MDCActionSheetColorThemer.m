...
+ (void)applySemanticColorScheme:(id<MDCColorScheming>)colorScheme
  ...
  actionSheetController.primaryTextColor =
      [colorScheme.onSurfaceColor colorWithAlphaComponent:(CGFloat)0.6f];
  actionSheetController.secondaryTextColor =
      [colorScheme.onSurfaceColor colorWithAlphaComponent:(CGFloat)0.87f];
