...
@interface ActivityIndicatorLocalizationTests : XCTestCase

@end

@implementation ActivityIndicatorLocalizationTests
...
- (void)testAccessibilityLabelIsTranslated {
  ...
  if ([languageCode isEqualToString:@"ar"]) {
    XCTAssertEqualObjects(indicator.accessibilityLabel, @"مؤشر النشاط");
  } else {
