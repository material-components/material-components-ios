...
static const CGFloat kFABBaselineShapeValuePercentage = 0.5f;

@implementation MDCFloatingActionButtonBaselineShapeThemer

+ (void)applyShapeBaselineToFloatingActionButton:(MDCFloatingButton *)button {
  CGFloat buttonHeight = button.bounds.size.height;
  CGFloat cornerValue = buttonHeight * kFABBaselineShapeValuePercentage;
