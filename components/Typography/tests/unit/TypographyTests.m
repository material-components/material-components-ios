...
- (void)testSystemFontDisplay4Font {
  ...
  XCTAssertEqualObjects(
      font, [UIFont systemFontOfSize:112],
      @"When the display 4 font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontDisplay3Font {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the display 3 font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontDisplay2Font {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the display 2 font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontDisplay1Font {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the display 1 font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontHeadlineFont {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the headline font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontTitleFont {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the title font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontSubheadFont {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the subhead font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontBody2Font {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the body 2 font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontBody1Font {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the body 1 font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontCaptionFont {
  ...
  XCTAssertEqualObjects(
      ...
      @"When the caption font fails to load we must load a system font of the correct size.");
}
...
- (void)testSystemFontButtonFont {
  ...
  XCTAssertEqualObjects(
      font, [UIFont boldSystemFontOfSize:14],
      @"When the button font fails to load we must load a system font of the correct size.");
}
