...
/**
 ...
 As an example, assume the metrics value for @c .Large is 12 and the current @c UIContentCategorySize is
 @c .ExtraLarge with a metrics value of 24.  When I pass a @c value of 10, I will expect a return
 value of 20.
