...
@protocol MDCUpdatedInkLayerDelegate;

@interface MDCUpdatedInkLayer : CAShapeLayer

/**
 Ink layer animation delegate.
 */
@property(nonatomic, weak) id<MDCUpdatedInkLayerDelegate> animationDelegate;
...
/**
 Delegate protocol for the MDCUpdatedInkLayer.
 */
@protocol MDCUpdatedInkLayerDelegate <CALayerDelegate>
...
/**
 ...
 @param inkLayer The MDCUpdatedInkLayer that starts animating.
 */
...
/**
 ...
 @param inkLayer The MDCUpdatedInkLayer that ends animating.
 */
