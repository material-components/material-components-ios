...
- (void)testTitleNumberOfLines {
  ...
  style.textOnlyTitleNumberOfLines = 2;
  ...
  // Then
  XCTAssertEqual(((UILabel *)[cellWithImageAndText valueForKey:@"_titleLabel"]).numberOfLines, 1);
  XCTAssertEqual(((UILabel *)[cellWithImageOnly valueForKey:@"_titleLabel"]).numberOfLines, 1);
  XCTAssertEqual(((UILabel *)[cellWithTextOnly valueForKey:@"_titleLabel"]).numberOfLines, 2);
}
