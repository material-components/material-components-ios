...
#import "MDCCardExperimentalColorThemer.h"
#import "MDCCard.h"
#import "MDCCardCollectionCell.h"

@implementation MDCCardExperimentalColorThemer

+ (void)applyExperimentalTheme:(MDCExperimentalColorScheme *)colorScheme toCard:(MDCCard *)card {
  [card setBorderColor:colorScheme.borderColor forState:UIControlStateNormal];
  [card setShadowColor:colorScheme.shadowColor forState:UIControlStateNormal];
