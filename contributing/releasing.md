...
> If you have configured Git with a GUI diff tool like [Kaleidoscope](https://itunes.apple.com/us/app/kaleidoscope/id587512244?mt=12) (`git difftool`), then you can add
