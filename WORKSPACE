...
http_archive(
    ...
    url = "https://github.com/bazelbuild/rules_apple/archive/0.5.0.zip",
    strip_prefix = "rules_apple-0.5.0",
    # Generated by running: openssl sha -sha256 <path to zip>
    sha256 = "02f646f83dabc456de0793fa0ecad7840aee5c67132ac417f8db5834416d6a80"
)
