module SnapshotPodspecHelper
  ...
  def self.snapshot_sources
    base_sources = ["components/private/Snapshot/src/*.{h,m,swift}", "components/private/Snapshot/src/Implementation/*.{h,m,swift}", "components/private/Snapshot/src/Supplemental/*.{h,m,swift}"]
