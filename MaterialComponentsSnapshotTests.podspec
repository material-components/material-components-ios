module SnapshotPodspecHelper
  ...
  def self.snapshot_sources
    base_sources = ["components/private/Snapshot/src/*.{h,m,swift}", "components/private/Snapshot/src/SnapshotTestCase/*.{h,m,swift}", "components/private/Snapshot/src/SnapshotUtilities/*.{h,m,swift}"]
