...
class MDCDrawDragons {
  ...
  static func drawTile(fillColor: UIColor, size: CGSize) {
    ...
    trianglePath.addLine(to: CGPoint(x: themesGroup.minX + 0.47619 * themesGroup.size.width, y: themesGroup.minY + 0.19394 * themesGroup.size.height))
    trianglePath.close()
    trianglePath.move(to: CGPoint(x: themesGroup.minX + 0.47619 * themesGroup.size.width, y: themesGroup.minY + 0.00000 * themesGroup.size.height))
    trianglePath.addLine(to: CGPoint(x: themesGroup.minX + 0.18254 * themesGroup.size.width, y: themesGroup.minY + 0.45455 * themesGroup.size.height))
    trianglePath.addLine(to: CGPoint(x: themesGroup.minX + 0.76984 * themesGroup.size.width, y: themesGroup.minY + 0.45455 * themesGroup.size.height))
    trianglePath.addLine(to: CGPoint(x: themesGroup.minX + 0.47619 * themesGroup.size.width, y: themesGroup.minY + 0.00000 * themesGroup.size.height))
    trianglePath.addLine(to: CGPoint(x: themesGroup.minX + 0.47619 * themesGroup.size.width, y: themesGroup.minY + 0.00000 * themesGroup.size.height))
    trianglePath.close()
    fillColor.setFill()
    trianglePath.fill()
    let circlePath = UIBezierPath()
    circlePath.move(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 0.64646 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.89418 * themesGroup.size.width, y: themesGroup.minY + 0.77273 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.83492 * themesGroup.size.width, y: themesGroup.minY + 0.64646 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.89418 * themesGroup.size.width, y: themesGroup.minY + 0.70303 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 0.89899 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.89418 * themesGroup.size.width, y: themesGroup.minY + 0.84242 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.83492 * themesGroup.size.width, y: themesGroup.minY + 0.89899 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.62963 * themesGroup.size.width, y: themesGroup.minY + 0.77273 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.68889 * themesGroup.size.width, y: themesGroup.minY + 0.89899 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.62963 * themesGroup.size.width, y: themesGroup.minY + 0.84242 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 0.64646 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.62963 * themesGroup.size.width, y: themesGroup.minY + 0.70303 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.68889 * themesGroup.size.width, y: themesGroup.minY + 0.64646 * themesGroup.size.height))
    circlePath.close()
    circlePath.move(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 0.54545 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.52381 * themesGroup.size.width, y: themesGroup.minY + 0.77273 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.63016 * themesGroup.size.width, y: themesGroup.minY + 0.54545 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.52381 * themesGroup.size.width, y: themesGroup.minY + 0.64697 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 1.00000 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.52381 * themesGroup.size.width, y: themesGroup.minY + 0.89848 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.63016 * themesGroup.size.width, y: themesGroup.minY + 1.00000 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 1.00000 * themesGroup.size.width, y: themesGroup.minY + 0.77273 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 0.89365 * themesGroup.size.width, y: themesGroup.minY + 1.00000 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 1.00000 * themesGroup.size.width, y: themesGroup.minY + 0.89848 * themesGroup.size.height))
    circlePath.addCurve(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 0.54545 * themesGroup.size.height),
                        controlPoint1: CGPoint(x: themesGroup.minX + 1.00000 * themesGroup.size.width, y: themesGroup.minY + 0.64697 * themesGroup.size.height),
                        controlPoint2: CGPoint(x: themesGroup.minX + 0.89365 * themesGroup.size.width, y: themesGroup.minY + 0.54545 * themesGroup.size.height))
    circlePath.addLine(to: CGPoint(x: themesGroup.minX + 0.76190 * themesGroup.size.width, y: themesGroup.minY + 0.54545 * themesGroup.size.height))
    circlePath.close()
    fillColor.setFill()
    circlePath.fill()
    let squarePath = UIBezierPath()
    squarePath.move(to: CGPoint(x: themesGroup.minX + 0.32143 * themesGroup.size.width, y: themesGroup.minY + 0.67045 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.32143 * themesGroup.size.width, y: themesGroup.minY + 0.87500 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.10714 * themesGroup.size.width, y: themesGroup.minY + 0.87500 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.10714 * themesGroup.size.width, y: themesGroup.minY + 0.67045 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.32143 * themesGroup.size.width, y: themesGroup.minY + 0.67045 * themesGroup.size.height))
    squarePath.close()
    squarePath.move(to: CGPoint(x: themesGroup.minX + 0.42857 * themesGroup.size.width, y: themesGroup.minY + 0.56818 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.00000 * themesGroup.size.width, y: themesGroup.minY + 0.56818 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.00000 * themesGroup.size.width, y: themesGroup.minY + 0.97727 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.42857 * themesGroup.size.width, y: themesGroup.minY + 0.97727 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.42857 * themesGroup.size.width, y: themesGroup.minY + 0.56818 * themesGroup.size.height))
    squarePath.addLine(to: CGPoint(x: themesGroup.minX + 0.42857 * themesGroup.size.width, y: themesGroup.minY + 0.56818 * themesGroup.size.height))
    squarePath.close()
    fillColor.setFill()
    squarePath.fill()
