...
void MDCCatalogDrawOverlayWindow(CGRect frame) {
  ...
  CGRect overlayWindowGroup = CGRectMake(CGRectGetMinX(frame) + 54, CGRectGetMinY(frame) + 38, floor((CGRectGetWidth(frame) - 54) * 0.59701 + 0.5), floor((CGRectGetHeight(frame) - 38) * 0.68376 + 0.5));


  UIBezierPath* rightCornerPath = [UIBezierPath bezierPath];
  [rightCornerPath moveToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 1.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.00000 * CGRectGetHeight(overlayWindowGroup))];
  [rightCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.00000 * CGRectGetHeight(overlayWindowGroup))];
  [rightCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.12500 * CGRectGetHeight(overlayWindowGroup))];
  [rightCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.87500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.12500 * CGRectGetHeight(overlayWindowGroup))];
  [rightCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.87500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.87500 * CGRectGetHeight(overlayWindowGroup))];
  [rightCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 1.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.87500 * CGRectGetHeight(overlayWindowGroup))];
  [rightCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 1.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.00000 * CGRectGetHeight(overlayWindowGroup))];
  ...
  [leftCornerPath moveToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.87500 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.15150 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.14588 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.12500 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.12500 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.27088 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.27650 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.00000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 1.00000 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.65000 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 1.00000 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.87500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 1.00000 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.87500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.87500 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.77500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.87500 * CGRectGetHeight(overlayWindowGroup))];
  [leftCornerPath addLineToPoint: CGPointMake(CGRectGetMinX(overlayWindowGroup) + 0.12500 * CGRectGetWidth(overlayWindowGroup), CGRectGetMinY(overlayWindowGroup) + 0.87500 * CGRectGetHeight(overlayWindowGroup))];
  ...
  UIBezierPath* overlapRectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(overlayWindowGroup) + floor(CGRectGetWidth(overlayWindowGroup) * 0.12500 + 0.5), CGRectGetMinY(overlayWindowGroup) + floor(CGRectGetHeight(overlayWindowGroup) * 0.12500 + 0.5), floor(CGRectGetWidth(overlayWindowGroup) * 0.87500 + 0.5) - floor(CGRectGetWidth(overlayWindowGroup) * 0.12500 + 0.5), floor(CGRectGetHeight(overlayWindowGroup) * 0.87500 + 0.5) - floor(CGRectGetHeight(overlayWindowGroup) * 0.12500 + 0.5))];
  [fillColor3 setFill];
